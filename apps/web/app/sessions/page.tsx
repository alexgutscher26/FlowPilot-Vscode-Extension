      ...
      <div className="flex h-screen w-full">
        <aside className="hidden md:flex flex-col w-64 bg-card border-r border-muted/40 h-full flex-shrink-0">
          ...
          <div className="p-4 border-t border-muted/40">
            <Link
              href="/settings/connect"
              className="flex items-center gap-2 p-2 bg-muted rounded-lg text-xs hover:bg-muted/80 transition-colors"
            >
                      ...
                      {isLoadingSessions ? (
                        ...
                        sessions.map((s) => (
                          <tr key={s.id} className="hover:bg-muted transition-colors group">
                            ...
                            <td className="px-6 py-4">
                              <span
                                className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium ${getColorForType(s.interactionType)}`}
                              >
                                {s.interactionType}
                              </span>
                            </td>
