            ...
            <main className="flex-1 flex flex-col items-center justify-center p-6 text-center">
                <div className="max-w-md w-full bg-card border border-muted/40 rounded-xl p-8 shadow-sm">
                    ...
                    <p className="text-muted-foreground mb-8">
                        Generate an API key to securely connect your VS Code extension to your
                        dashboard. This enables session tracking, history, and AI insights.
                    </p>
                    ...
                    {!apiKey ? (
                        ...
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <button
                                onClick={() => window.location.href = `vscode://flowpilot.flowpilot/auth?key=${apiKey}`}
